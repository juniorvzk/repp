...
allowedUnities = [
  "AMPOLA","BALDE","BANDEJ","BARRA","BISNAG","BLOCO","BOBINA","BOMB","CAPS","CART","CENTO","CJ","CM","CM2",
...
Schema.tributosSchema = new SimpleSchema({
  ...
  "icms.simplesnacional":{
    type: Object,
    label: "Simples Nacional",
    optional: true
  },
  "icms.simplesnacional.situacaotributaria":{
      type: String,
      optional: true
  },
  "icms.simplesnacional.origem":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.aliquotacc":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.creditoicms":{
    type: String,
    optional: true

  },
  // "icms.simplesnacional.icmsst":{
  //   type: String,
  //   label: "ICMS ST",
  //   optional: true
  //
  ...
  "icms.simplesnacional.icmsst.modalidade":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.reducao":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.basedecalculo":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.margem":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.aliquota":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.valoricmsst":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.bcretido":{
    type: String,
    optional: true

  },
  "icms.simplesnacional.icmsst.valorretido":{
    type: String,
    optional: true

  },

  "icms.simplesnacional.icms":{
    type: Object,
    label: "ICMS",
    // autoform:{
    //   afObjectField:{
  ...
  "icms.simplesnacional.icms.modalidade":{
    type: String,
    label: "ICMS Modalidade ",
    optional: true

  },
  "icms.simplesnacional.icms.reducao":{
    type: String,
    label: "ICMS % Redução ",
    optional: true

  },
  "icms.simplesnacional.icms.margem":{
    type: String,
    label: "ICMS Margem ",
    optional: true

  },
  "icms.simplesnacional.icms.basedecalculo":{
    type: String,
    label: "ICMS Base de Calculo ",
    optional: true

  },
  "icms.simplesnacional.icms.aliquota":{
    type: String,
    label: "ICMS Alíquota ",
    optional: true

  },
  "icms.simplesnacional.icms.valoricms":{
    type: String,
    label: "Valor ICMS ",
    optional: true

  },
  "icms.simplesnacional.icms.bcretido":{
    type: String,
    label: "ICMS Base de Calculo Valro Retido ",
    optional: true

  },
  "icms.simplesnacional.icms.valorretido":{
    type: String,
    label: "ICMS Valor Retido ",
    optional: true
  ...
  "ipidevolvido.percentualdevolvido":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "ipidevolvido.valoripidevolvido":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.percentualicmsfcp":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.basedecalculodestinatario":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.aliquotainternadestinatario":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.aliquotainterestadual":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.percentualpartilha":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.valoricmspartilhadestinatario":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.valoricmspartilharemetente":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
  ...
  "icmsinterestadual.valoricmsfcp":{
    type: String,
    optional: true,
    autoform:{
        "formgroup-class":"col-lg-3",
...
Schema.icmsInter = new SimpleSchema({


  basedecalculodestinatario:{
    type: String,
    optional: true
  },
  aliquotainternadestinatario:{
    type: String,
    optional: true
  },
  ...
  valoricmspartilhadestinatario:{
    type: String,
    optional: true
  },
  valoricmspartilharemetente:{
    type: String,
    optional: true
  },
  valoricmsfcp:{
